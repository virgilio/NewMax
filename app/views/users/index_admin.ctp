    ...
    <table cellpadding="0" cellspacing="0" class="table_general_layout ">
        ...
        <tr<?php echo $class;?>>
            ...
            <td class="actions">
                    ...
                    <?php echo $this->Html->link(__('BLABLABLA', true), array('action' => 'delete', $user['User']['id']), null, sprintf(__('Tem certeza que deseja BLABLABLA o usuário \'%s\'?', true), $user['User']['username'])); ?>
            </td>
        </tr>
        <?php endforeach; ?>
        <tfoot>
